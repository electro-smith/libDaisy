...
// chunks by skipping. Does not load sample data; records data offset & length
...
// FILE*, flash, etc. (See `AudioFileUtils.h` in this project for an IReader for
// FatFS)
//
// Typical usage:
...
//   }
//
// This header is self-contained besides <cstdint>/<cstddef>/<cstdio> when
// FileReader used.

#include <cstddef>
#include <cstdint>
#ifdef WAV_PARSER_ENABLE_FILE_READER
#include <cstdio>
#endif
...
// Simple FILE* based reader for desktop testing. Not for embedded if stdio not
// available.
#ifdef WAV_PARSER_ENABLE_FILE_READER
