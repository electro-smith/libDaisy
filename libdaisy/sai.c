...
void dsy_sai1_init(uint8_t board, uint8_t bitdepth)
{
	...
	dsy_sai_handle.bitdepth[DSY_SAI_1] = bitdepth;
	dsy_sai_handle.board			   = board;
...
void dsy_sai2_init(uint8_t board, uint8_t bitdepth)
{
	...
	dsy_sai_handle.bitdepth[DSY_SAI_2] = bitdepth;
	dsy_sai_handle.board			   = board;
...
void HAL_SAI_MspInit(SAI_HandleTypeDef* hsai)
{
    ...
    PE6     ------> SAI1_SD_A 
    */
		if(dsy_sai_handle.board != DSY_SYS_BOARD_AUDIO_BB)
		{
			GPIO_InitStruct.Pin
    ...
    */
	...
	if(hsai->Instance == SAI2_Block_A)
	{
		...
		/**SAI2_A_Block_A GPIO Configuration  Rev1
    PD13     ------> SAI2_SCK_A
    PD12     ------> SAI2_FS_A
    PD11     ------> SAI2_SD_A 
    */
		/**SAI2_A_Block_A GPIO Configuration  Rev2
    PD11	------> SAI2_SD_A 
    */
	...
	if(hsai->Instance == SAI2_Block_B)
	{
		...
		/**SAI2_B_Block_B GPIO Configuration (rev2)
    PA0     ------> SAI2_SD_B 
	PG9		------> SAI2_FS_B
	PA2		------> SAI2_SCK_B
	PA1		------> SAI2_MCLK_B (not implemented here)
    */
