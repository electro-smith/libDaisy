...
#define DSY_QSPI_TEXT __attribute__((section(".qspiflash_text"))) /**< used for reading memory in memory_mapped mode. */
#define DSY_QSPI_DATA __attribute__((section(".qspiflash_data"))) /**< used for reading memory in memory_mapped mode. */
#define DSY_QSPI_BSS __attribute__((section(".qspiflash_bss")))   /**< used for reading memory in memory_mapped mode. */
