...
*/
    typedef struct
    {
        dsy_gpio_pin pin_config[DSY_SR_4021_PIN_LAST]; /**< used to initialize the dsy_gpio */
	  ...
	  num_daisychained; /**< Number of devices daisy chained */
        ...
        uint8_t      states[8 * SR_4021_MAX_DAISYCHAIN * SR_4021_MAX_PARALLEL]; /**< array of states */
    } dsy_sr_4021_handle;
