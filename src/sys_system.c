...
static void SystemClock_ConfigFast(void);
static void MPU_Config();
static void Error_Handler(void);
static void CheckPllFreqs(void);
...
static void SystemClock_ConfigFast(void)
{
  ...
  */
    ...
    // Enable all Peripheral GPIO clocks.
...
// 400MHz -- All periphs tested, and function
